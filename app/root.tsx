...
import { ProductProvider } from 'public/utils/ProductsContext';
import { PricingProvider } from 'public/utils/PricingContext';
export type RootLoader = typeof loader;
import { json, type ActionFunctionArgs } from '@shopify/remix-oxygen';

// Define the action function to handle the POST request
export async function action({ request }: ActionFunctionArgs) {
  ...
  // Perform your logic here, e.g., saving the selected plan to a session or updating cart
  console.log(`Selected Plan: ${selectedPlan}`);

  // Return success response
  return json({ success: true, selectedPlan });
}
/**
