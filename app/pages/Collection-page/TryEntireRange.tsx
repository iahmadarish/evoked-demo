...
import arrowRight from "/assets/ArrowForCollectionButton.svg";
...
const TryEntireRange = () => {
  ...
  return (
    ...
    <div className="flex-col justify-start items-start gap-5 flex">
        ...
        <div className="flex-col justify-start items-start gap-2.5 flex">
            <div className="justify-start items-start gap-[5px] inline-flex">
                <img src={arrow} alt='Arrow'  className='lg:w-auto lg:h-auto w-[20px] h-[20px]' />
    ...
    <Link to='/' className="lg:px-[30px]  lg:py-[18px] px-[20px] py-[10px] bg-white rounded-[var(--md,8px)] border shadow-[4px_4px_0px_0px_#FFF] border-solid border-black justify-start items-center gap-2.5 inline-flex">
