...
const Hero = () => {
  return (
    <section>
        <div className="bg-hero z-[-1] relative after:absolute after:top-0 after:left-0 after:w-full after:h-full after:content-[''] after:bg-[#0000004D] after:z-[-10]  bg-cover bg-center 2xl:pt-[215px] 2xl:pb-[150px] pb-[60px] pt-[120px]  lg:pt-[150px] lg:pb-[100px]">
